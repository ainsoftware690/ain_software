...
export default function ReservationKart() {
  ...
  return (
    <div>
      <div className="bg-black text-white py-6 text-center mt-12">
        ...
        <Modal>
          ...
          <ModalBody>
            ...
            <ModalFooter className="gap-4">
              ...
              <button onClick={() => alert('+1888579356')} className="bg-black text-white dark:bg-white dark:text-black text-sm px-2 py-1 rounded-md border border-black w-28">
                Book Now
              </button>
            </ModalFooter>
          </ModalBody>
